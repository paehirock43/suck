class Shoes:
    def __init__(self, id, brand, model):
        ...
        self.__net = 0.00
        self.__setPrice_and_setDiscount()

    def __setPrice_and_setDiscount(self):
        if self.__brand == "1":
            if self.__model == "1":
    ...
    def getBrand(self):
        ...
        self.__brand = brand_name[self.__brand]
        return self.__brand
    ...
    def getModel(self):
        ...
        self.__model = model_name[self.__brand][int(self.__model) - 1]
        return self.__model
    ...
    def __str__(self):
        return ("Id: {0},Brand: {1},Model: {2},Price: {3:.2f},"
                "Discount: {4:.2f},Net: {5:.2f}").format(self.__id, self.__brand, self.__model,self.__price,
                                                         self.__discount, self.__net)
